<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('admin/admin-management') ? 'active' : '' }}" href="{{route('admin.management.index')}}">
              <span data-feather="settings"></span>
              Admin Management
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link  {{ Request::is('admin/list-product') ? 'active' : '' }}" href="{{route ('admin.product-list')}}">
