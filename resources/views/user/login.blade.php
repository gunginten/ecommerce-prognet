...
<head>
    ...
    <title>Toko Tanaman | Login</title>
    <!-- Favicon icon -->
            ...
            <div class="row no-gutters">
              <div class="col-xl-12">
                <div class="auth-form">
                  ...
                  <form class="form" method="POST" action="{{ route('login_proses') }}">
                    @csrf
                  ...
                  <div class="new-account">
                    <p><a class="text-primary" href="{{Route('password.request')}}">Forgot password?</a></p>
                  </div>
                </div>
              </div>
            </div>
